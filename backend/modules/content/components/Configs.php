 ...
 *     'mdm.admin.configs' => [
 *         'db' => 'customDb',
 *         'navigationTable' => '{{%admin_navigation}}',
 *         'cache' => [
 ...
 *
 * ```
 * Yii::$container->set('content\components\Configs',[
 *     'db' => 'customDb',
 *     'navigationTable' => 'admin_navigation',
 * ]);
 * ```
...
class Configs extends \yii\base\BaseObject
{
    ...
    /**
     * @var string navigation table name.
     */
    public $navigationTable = '{{%navigation}}';
	 /**
     * @var string navigation table name.
     */
     ...
     * @return string
     */
    public static function navigationTable()
    {
        return static::instance()->navigationTable;
    }
