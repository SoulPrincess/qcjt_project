...
<div class="layui-form qing-case-index">
    <?=
    GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'case_img',
                'contentOptions' => ['style'=> 'text-align: center;'],
                'headerOptions' => ['width' => '80px','style'=> 'text-align: center;'],
                "format"=>[
                    "image",
                    [
                        "width"=>"30px",
...
//            'case_content',
            [
                ...
                'value' => function($model) {
                    return $model->case_status==2?'<font color="red">否</font>':'<font color="green">是</font>';
                },
